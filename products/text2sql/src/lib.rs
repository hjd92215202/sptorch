...
//!
//! This crate intentionally remains product-service focused and framework-agnostic.
//! Model training/inference implementations are injected from product runtimes.
